/* ---------- API CLIENT ----------
   Talks to the Node/Express back-end. Leave API_BASE empty to call the same
   origin that serves the page (default when front-end and back-end are
   deployed together). Set it to your API URL (e.g. "https://api.example.com")
   if you host the back-end separately. */
const API_BASE = "";
